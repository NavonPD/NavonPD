...
# ===========================================================================
HOST = "NavonPD"   # shown as  NavonPD@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Founder & Dev @ Infidevs"),
    ("kv", "Building", "navonpd.infidevs.in"),
    ("kv", "Role", "Full-stack · UI/UX · Creative Dev"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript"),
    ("kv", "Backend", "Node.js, Express, REST APIs"),
    ("kv", "Styling", "Tailwind CSS, Framer Motion"),
    ("kv", "Tools", "Git, Vercel, Figma, VS Code"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built Infidevs — a creative dev studio"),
    ("bul", "Crafting web experiences with soul"),
    ("bul", "Always shipping something new"),
]
